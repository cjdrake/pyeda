...
def test_num2upoint():
    assert num2upoint(0x0, [a, b, c, d]) == [{1, 2, 3, 4}, set()       ]
    ...
    assert num2upoint(0x5, [a, b, c, d]) == [{   2,    4}, {1,    3   }]
    ...
    assert num2upoint(0xA, [a, b, c, d]) == [{1,    3   }, {   2,    4}]
    ...
    assert num2upoint(0xF, [a, b, c, d]) == [ set(),       {1, 2, 3, 4}]
...
def test_point2upoint():
    assert point2upoint({a: 0, b: 0, c: 0, d: 0}) == [{1, 2, 3, 4}, set()       ]
    ...
    assert point2upoint({a: 1, b: 0, c: 1, d: 0}) == [{   2,    4}, {1,    3   }]
    ...
    assert point2upoint({a: 0, b: 1, c: 0, d: 1}) == [{1,    3   }, {   2,    4}]
    ...
    assert point2upoint({a: 1, b: 1, c: 1, d: 1}) == [set(),        {1, 2, 3, 4}]
